...
def format_and_create_pdf(content:str, filename: str) -> str:
    ...
    body_style.fontSize = 12          # Increased from default 10
    body_style.leading = 12           # Increased spacing between lines
    body_style.alignment = 4          # Justified text (looks more professional and fills space)
